    ...
    return (
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <Pressable
            style={styles.loginBtn}
            onPress={() => emailLogin(email, password, props.setLoggedInStatus)}
          >
            <Text style={styles.loginText}>LOGIN</Text>
          </Pressable>
      ...
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <Pressable
            style={styles.loginBtn}
            onPress={() =>
              emailSignUp(email, password, props.setLoggedInStatus)
            }
          >
            <Text style={styles.loginText}>SIGN UP</Text>
          </Pressable>
